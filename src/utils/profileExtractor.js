...
const DOMAIN_SYNONYMS = {
  '人工智能': ['人工智能', 'ai', 'artificial intelligence', '机器智能'],
  '金融科技': ['金融科技', 'fintech', '金融', '银行', '证券', '风控'],
  '跨境支付AI监测': ['跨境支付', '支付监测', '反洗钱', 'aml', '交易监测'],
  '医疗健康': ['医疗', '健康', '医学', 'healthcare', '医院', '生物医药'],
  '网络安全': ['网络安全', '信息安全', 'security', '安全', '入侵检测'],
  '智能制造': ['智能制造', '工业', '制造', 'manufacturing', '工业互联网'],
  '智慧交通': ['交通', '智慧交通', '自动驾驶', '车联网', 'transportation'],
  '教育科技': ['教育', 'edtech', '在线教育', '教学'],
  '电子商务': ['电子商务', '电商', 'e-commerce', '零售', '推荐'],
  '物联网': ['物联网', 'iot', '传感器', '边缘计算']
}
