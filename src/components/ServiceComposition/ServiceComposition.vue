<template>
  <div>
    ...
    <a-modal
      ...
      :width="'auto'"
      :bodyStyle="{ width: modalContent === 'schedule' ? 'auto' : ( modalContent === 'largeModel' ? '600px' : '400px' ) }"
      :dialog-style="modalContent === 'schedule' ? { top: 0 } : {}"
      :footer="false"
      ...
      <div v-if="modalContent === 'buttons'">
        <a-form>
          <a-form-item label="请选择组合方式">
            <a-button type="primary" @click="handleVisualArrangement">可视化编排</a-button>
