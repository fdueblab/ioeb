<template>
  <div class="all">
    <a-tabs default-active-key="1">
      <a-tab-pane key="1" tab="模拟飞行训练" force-render>
        <el-image :src="require('@/assets/simulator.png')" style="width: 80%;" v-show="simulatorStatus"></el-image>
