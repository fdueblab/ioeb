...
export default {
  ...
  data () {
    return {
      options: null,
      industryOptions: getIndustryMap('evtol'),
      scenarioOptions: getScenarioMap('evtol'),
      technologyOptions: getTechnologyMap('evtol'),
      programInfo: {
        industry: undefined,
        scenario: undefined,
  ...
  methods: {
    ...
    uploadService () {
      ...
      setTimeout(() => {
        ...
        window.location.href = `#/evaluation/evtol/technology`
      }, 1000)
    },
