...
export const domainMockData = {
  ...
  'agriculture': {
    checkFile: null,
    nodes: [
      { id: '9001', x: 0, y: 150, label: 'soil_analysis', size: 50, input: 'soilData', output: 'soilQuality', environment: '田间环境', process: '土壤质量检测', apiType: 0, methodType: 0, inputType: 2, outputType: 2 },
      { id: '9002', x: 150, y: 150, label: 'crop_monitoring', size: 50, input: 'cropImages', output: 'cropHealth', environment: '低带宽环境', process: '作物生长监测', apiType: 0, methodType: 1, inputType: 2, outputType: 2 },
      { id: '9003', x: 300, y: 150, label: 'pest_detection', size: 50, input: 'cropHealth', output: 'pestThreat', environment: '边缘设备', process: '病虫害检测', apiType: 2, methodType: 1, inputType: 2, outputType: 2 },
      { id: '9004', x: 450, y: 50, label: 'irrigation_control', size: 50, input: 'soilQuality', output: 'irrigationPlan', environment: '节能环境', process: '智能灌溉控制', apiType: 0, methodType: 0, inputType: 2, outputType: 1 }
    ],
    edges: [
  ...
  'evtol': {
    checkFile: null,
    nodes: [
      { id: '9001', x: 0, y: 150, label: 'flight_path', size: 50, input: 'locationData', output: 'flightRoute', environment: '低空飞行环境', process: '飞行路径规划', apiType: 0, methodType: 0, inputType: 2, outputType: 2 },
      { id: '9002', x: 150, y: 150, label: 'obstacle_detection', size: 50, input: 'sensorData', output: 'obstacleMap', environment: '实时处理环境', process: '障碍物检测', apiType: 0, methodType: 1, inputType: 2, outputType: 2 },
      { id: '9003', x: 300, y: 150, label: 'collision_avoidance', size: 50, input: 'obstacleMap', output: 'avoidanceCommand', environment: '紧急响应环境', process: '防碰撞处理', apiType: 2, methodType: 1, inputType: 2, outputType: 2 }
    ],
    edges: [
  ...
  'ecommerce': {
    checkFile: null,
    nodes: [
      { id: '9001', x: 0, y: 150, label: 'market_trends', size: 50, input: 'marketData', output: 'trendAnalysis', environment: '跨境环境', process: '市场趋势分析', apiType: 0, methodType: 0, inputType: 2, outputType: 2 },
      { id: '9002', x: 150, y: 150, label: 'product_recommendation', size: 50, input: 'userBehavior', output: 'recommendations', environment: '多语言环境', process: '产品推荐', apiType: 0, methodType: 1, inputType: 2, outputType: 2 },
      { id: '9003', x: 300, y: 150, label: 'pricing_strategy', size: 50, input: 'trendAnalysis', output: 'priceSuggestions', environment: '实时更新环境', process: '价格策略生成', apiType: 2, methodType: 1, inputType: 2, outputType: 2 }
    ],
    edges: [
      { sourceID: '9001', targetID: '9003' },
      { sourceID: '9002', targetID: '9003' }
  ...
  'homeAI': {
    checkFile: null,
    nodes: [
      { id: '9001', x: 0, y: 150, label: 'voice_recognition', size: 50, input: 'audioInput', output: 'commandText', environment: '家庭环境', process: '语音识别', apiType: 0, methodType: 0, inputType: 2, outputType: 2 },
      { id: '9002', x: 150, y: 150, label: 'emotion_analysis', size: 50, input: 'userInput', output: 'emotionState', environment: '隐私保护环境', process: '情感分析', apiType: 0, methodType: 1, inputType: 2, outputType: 2 },
      { id: '9003', x: 300, y: 150, label: 'conversation', size: 50, input: 'commandText,emotionState', output: 'response', environment: '低延迟环境', process: '对话生成', apiType: 2, methodType: 1, inputType: 2, outputType: 2 }
    ],
    edges: [
      { sourceID: '9001', targetID: '9003' },
      { sourceID: '9002', targetID: '9003' }
