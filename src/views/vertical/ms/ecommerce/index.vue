            ...
            <a-col :span="6">
              <a-form-item label="领域">
                <a-select placeholder="请选择" default-value="0">
                  <a-select-option value="0">跨境电商AI监控服务</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
            <a-col :span="6">
...
export default {
  ...
  data () {
    return {
      options: null,
      industryOptions: getIndustryMap('ecommerce'),
      scenarioOptions: getScenarioMap('ecommerce'),
      technologyOptions: getTechnologyMap('ecommerce'),
      programInfo: {
        industry: undefined,
        scenario: undefined,
  ...
  methods: {
    ...
    uploadService () {
      ...
      setTimeout(() => {
        ...
        window.location.href = `#/evaluation/ecommerce/technology`
      }, 1000)
    },
