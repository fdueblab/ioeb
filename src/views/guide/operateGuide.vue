    ...
    <div>
      ...
      <div class="feature-section">
        ...
        <ol>
          ...
          <li>
            在<b>“微服务与元应用检索”</b>中可以检索到发布的微服务并进行调用。
          </li>
        </ol>
        <a-divider />
        <h3>
        ...
        <ol>
          ...
          <li>
            在<b>“垂域元应用仿真构建”</b>中，组合编排原子微服务中的接口来构建元应用，或者先让AI智能选取并建议组合编排，之后自行修改元应用工作流。
          </li>
          <li>
          ...
          <li>
            在<b>“微服务与元应用检索”</b>中可以检索并使用发布的元应用。
          </li>
        </ol>
      </div>
    </div>
          ...
          formatter: (params) => {
            if (params.dataType === 'node') {
              ...
              const nodeDescriptions = {
                ...
                'node-3': '在<b>“微服务与元应用检索”</b>下可以检索到发布的服务并进行调用',
                'node-4': '在<b>“微服务与元应用检索”</b>中检索已有的原子微服务与元应用，构思自己的元应用需求。',
                'node-5': '在<b>“垂域元应用仿真构建”</b>中，结合智能体来组合编排元应用工作流。<br></br>编排完成后点击<b>“构建为元应用”</b>按钮，定制并填写信息后预发布构建好的元应用。',
                'node-6': '在<b>“技术测评与业务验证”</b>下的<b>“元应用业务数据验证”</b>中检验元应用',
                'node-7': '在<b>“微服务与元应用检索”</b>中可以检索并使用发布的元应用'
              }
