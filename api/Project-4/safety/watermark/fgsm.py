...
from robustness.grb.attack.base import InjectionAttack, EarlyStop
from robustness.grb.evaluator import metric
from robustness.grb.utils import utils
import copy
...
class FGSM_test_simple(InjectionAttack):
	...
	def attack(self,
		...
		return data_atk, node_features_attack, edge_features_attack, labels_origin, risk_idx
	...
	def injection(self,
		...
		for idx in range(n_inject):
			if n_edge_max > len(risk_idx):
				n_edge_max = len(risk_idx)
