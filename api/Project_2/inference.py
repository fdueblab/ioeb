...
class InferenceModel:
    def __init__(self, model_path: str = 'checkpoint/model_horizontal.pt', device: str = 'cpu') -> None:
        self.model_path = model_path
        self.device = torch.device(device)
        self.model = None
        
    def load_model(self, in_feats: int, in_efeats: int, h_feats: int, out_feats: int) -> None:
        """加载预训练模型"""
        self.model = model(in_feats, in_efeats, h_feats, out_feats)
...
def main() -> None:
    ...
    inference_model = InferenceModel(
        model_path='checkpoint/model_horizontal.pt',
