...
::: tip Swagger API 文档
**完整接口文档：** 请访问当前环境对应的 Agent Swagger 地址。

- 开发测试环境：`http://dev.fdueblab.cn:8010/`
- 生产环境：`http://fdueblab.cn:8010/`
...
::: warning 接口说明
平台提供了多个Agent接口，每个接口对应一个特定的任务。下面是**部分示例接口**，完整的接口列表请查看当前环境对应的 Swagger 文档。

**基础 URL：** 使用当前环境的访问域名，例如 `http://dev.fdueblab.cn` 或 `https://fdueblab.cn`。
:::
...
::: tip 相关资源
- **Swagger API 文档：** 当前环境对应的 Agent Swagger 地址
- **项目仓库：** [https://github.com/fdueblab/ioeb](https://github.com/fdueblab/ioeb)
- **相关文档：**
